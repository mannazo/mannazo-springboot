...
public interface UserAPI {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "401", description = "사용자 정보를 보는 것이 허용되지 않습니다."),
            @ApiResponse(responseCode = "403", description = "찾으려고 하는 사용자 정보에 접근하는 것은 금지되어 있습니다. 토큰을 확인해주세요."),
            @ApiResponse(responseCode = "404", description = "찾으려고 하는 사용자 정보는 존재하지 않습니다.")
    })
